...
#spark = SparkSession.builder.appName("stackoverflow").config("spark.driver.memory", "100g").config("spark.executer.memory", "100g").getOrCreate()

#spark = SparkSession.builder.appName("stackoverflow").master("spark://10.46.0.14:8893").config("spark.driver.memory", "100g").config("spark.executer.memory","100G").getOrCreate()


#spark = SparkSession.builder.appName("stackoverflow").master("spark://10.46.0.14:8893").config("spark.driver.memory", "50g").config("spark.executer.memory", "50g").getOrCreate()
